		...
		<div id="main">
			<div class="top-wrapper clear">
				<div id="content">
					...
					<form id="content-searchform" class="article-search-form" action="empSearch.htm" method="get">
						<fieldset>
							<legend class="hidden">
								목록 검색 폼
							</legend>
							<label class="hidden" for="keyword">검색어</label>
							<input type="text"
							name="keyword" value="" />
					...
					<table class="article-list margin-small">
						...
						<tbody>
							...
							<tr>
								<td class="empno"><a href="empDetail.htm?empno=${n.empno}" >${n.empno}</a>&emsp;|&emsp;</td>
					...
					<p class="article-comment margin-small">
						<button id="insertbtn" onclick="location.href='empReg.htm'">사원 추가</button>
					</p>
