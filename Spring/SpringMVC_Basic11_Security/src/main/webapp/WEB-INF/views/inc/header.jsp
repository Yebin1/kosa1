...
<div id="header">
	<div class="top-wrapper">
		...
		<ul id="loginmenu" class="block_hlist">
			<li><a href="${pageContext.request.contextPath}/index.htm">HOME</a>
			</li>
			<%-- <li>
			...
			<se:authorize access="!hasRole('ROLE_USER')"> <!-- if문 -->
				<li><a href="${pageContext.request.contextPath}/joinus/login.htm">로그인</a>
			</se:authorize>
			
			<!-- 인증이 성공하면 Spring 내부적으로 객체 생성: userPrincipal 객체가 가지는 속성값; name -->
