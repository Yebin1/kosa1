...
<div id="header">
			<div class="top-wrapper">
				...
				<ul id="loginmenu" class="block_hlist">
					...
					<!-- 
					2단계
					JSTL 사용해서 security 객체 사용 (login)
					...
					<se:authorize access="!hasRole('ROLE_USER')"> <!-- if문  -->
						  <li><a href="${pageContext.request.contextPath}/joinus/login.htm">로그인</a></li>
					</se:authorize>
					
					<!-- 인증이 성공하면 Spring 내부적으로 객체 생성 : userPrincipal객체가 가지는 속성값 : name   -->
				...
				<ul id="membermenu" class="clear">
					<li>
						<a href="${pageContext.request.contextPath}/mypage/mypage.htm"><img src="${pageContext.request.contextPath}/images/menuMyPage.png" alt="마이페이지" /></a>
					</li>
					<li>
