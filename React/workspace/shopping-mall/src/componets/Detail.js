...
function Detail(props) {
    ...
    return(
      ...
      {/* <Tabs defaultActiveKey="link0"   transition={false} >
          <Tab  eventKey="link0" onClick={setClickTab(0)} title="환불정책">button0</Tab>          
          <Tab  eventKey="link1" onClick={setClickTab(1)} title="교환방법">button1</Tab>
          <Tab  eventKey="link2" onClick={setClickTab(2)} title="배송문의">button2</Tab>
...
function TabComponet({clickTab}) {
  ...
  return (
    <div className={`start ${fade}`}>
      {/* {stock[2]} */}
        {[<div>내용0<br/>내용0<br/>내용0</div>, <div>내용1<br/>내용1<br/>내용1</div>, <div>내용2</div>][clickTab]}
    </div>
  )
