                ...
                <table class="table" width="95%" align="center">
                 <tr>
                    ...
                    <tr>
						...
						<button id="boardMap" type="button" class="btn btn-primary rounded-pill m-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop" value="지도"><img src="images/MapImage.png" alt="" style="width:30px; height:30px"></button>
							  ...
							  <div class="modal-dialog modal-xl" >
							    <div class="modal-content ">
							      ...
							      <div class="modal-footer">
 							        <button type="button" id="Understood" class="btn btn-primary" data-bs-dismiss="modal">완료</button>
							      </div>
							    </div>
							  </div>
							</div>
                    ...
                    <tr>
					   ...
					   <td width="50%" align="left">
					    <span style="floating:left">
						   <input type="text" name="apply" size="40" maxlength="25" class="form-control" style="width:400px;" placeholder="작성하신 Google Form을 넣어주세요">
					   </span>
					    <span style="floating:left">
						   <button class="btn btn-primary rounded-pill m-2"  type="button" onClick="window.open('http://forms.google.com')">구글폼</button>
					   </span>
					   </td>
					</tr>
