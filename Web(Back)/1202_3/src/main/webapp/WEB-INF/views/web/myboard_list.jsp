...
<body>
	...
	<div id="pagecontainer">
		<div class="bg-light rounded h-100 p-4">
			<h4 class="mb-4">
				<b>내가 쓴<span style="color: #2C91F7;"> 게시물</span></b>
			</h4>
			<br>
			<table class="table" width="80%" cellspacing="0" align="center">
				...
				<c:forEach var="board" items="${myList}">
					<tr onmouseover="this.style.backgroundColor='skyblue'"
						...
						<td align="left"><a
							href="boardContent.user?boardname=${board.boardname}&idx=${board.idx}&cp=${cpage}&ps=${pagesize}">
								<c:choose>
									<c:when
					...
					<td colspan="3" align="center">
						<!--이전 링크 --> <c:if test="${cpage > 1}">
							...
							<c:choose>
								...
								<c:otherwise>
									<a href="myboardList.user?cp=${i}&ps=${pagesize}">[${i}]</a>
								</c:otherwise>
							</c:choose>
	...
	<div>
		<button type="button" class="btn btn-primary rounded-pill m-2"
			onclick="location.href='myreplyList.user';">내가 쓴 댓글</button>
