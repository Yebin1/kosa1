...
<body>
	...
	>> 실경로               D:\bit2021\WEB(Back)\WebLabs\WebJSP
	       ...
	       >> C:\KOSA_IT\Web(Back)\Labs\WebJSP\src\main\webapp  (context root)
	       >> 192.168.0.028:8090/WebJSP  >> webapp 안에 자원을 서비스 하겠다
	...
	/*  
		...
		**실제 현업 개발코드는... webapp 폴더에 없어요
		1. Client 직접 요청하는 파일 : main.html , login.html , register.htm >> webapp
	...
	*/
	...
	<h3>Application 객체 (WAS 자동 제공)</h3>
