<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <!-- Navbar Start -->
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4" action="HeaderSearchService.user" method="post" name="headersearch" id="headersearch">
                ...
                <script type="text/javascript">
						window.onload = function() {
						 ...
						 function submit(frm) { 
							 console.log("submit 할거임")
							    frm.action='HeaderSearchService.user'; 
							    frm.submit(); 
							    console.log("submit됨");
							    return true; 
							  } 
