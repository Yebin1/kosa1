...
<body>
	...
	<div id="pageContainer">
		...
		<!-- 연습용 모달 버튼 -->
	<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">쪽지 보내기</button>
	<!--  -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="message-text" name = "messagecontent" id = "messagecontent" placeholder = "내용을 입력해주세요"></textarea>
          </div>
