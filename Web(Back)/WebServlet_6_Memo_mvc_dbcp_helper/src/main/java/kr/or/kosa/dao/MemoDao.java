...
public class MemoDao {
	/*
	 * 싱글톤 방식 연습 (DB연결) Connection conn = null;
	 * 
	 ...
	 * DataSource ds = null;
	 * 
	 * public MemoDao() { try { //JNDI Context context = new InitialContext(); //현재
	 * [프로젝트]에서 특정 이름을 가진 객체를 검색 (사용 : 이름기반 검색) ds =
	 * (DataSource)context.lookup("java:comp/env/jdbc/oracle"); // 정해진 약속 :
	 * java:comp/env/ + jdbc/oracle //lookup 된 객체의 타입이 DataSource } catch (Exception
	 * e) { e.printStackTrace(); } }
	 */
	// 전체조회
