				...
				<table width="80%" border="1">
					...
					<tr>
						<td colspan="4" align="center"><a
							href="javascript:history.back();">목록가기</a> 
							| <a href="boardEdit.user?boardname=${board.boardname}&idx=${idx}&cp=${cpage}&ps=${pagesize}&filename=${filename}">편집</a>
							| <a href="boardDelete.user?boardname=${board.boardname}&idx=${idx}&cp=${cpage}&ps=${pagesize}&writerid=${board.userid}">삭제</a>
