...
<body>
	...
	<div id="pagecontainer">
		...
		<h4 class="mb-4"><b><span style="color:#2C91F7;">${boardname}</span></b></h4><br>
			<table class="table"><!-- width="80%" border="1" cellspacing="0" align="center" -->
				<tr>
				<td colspan="5">
							<form name="boardheader" action='HeaderSearchService.user' id="boardheader">
								<select class="form-select form-select-sm mb-3"
									aria-label=".form-select-sm example" name="boardheader"
									id="boardheader" onchange="changeHeader()"
									style="width: 100px;">
									<option value="전체" id="allList">전체</option>
				...
				<c:forEach var="board" items="${boardList}">
					<tr onmouseover="this.style.backgroundColor='skyblue'" onmouseout="this.style.backgroundColor='white'">
						...
						<td align="center" id="ajax_boardheader">${board.boardheader}</td>
						<td id="ajax_title">
						...
						<td id="ajax_userid">${board.userid}</td>
						<td id="ajax_writedate">${board.writedate}</td>
						<td id="ajax_lovenum">${board.lovenum}</td>
						<td id="ajax_readnum">${board.readnum}</td>
					</tr>
				</c:forEach>
				<!-- forEach()  -->
