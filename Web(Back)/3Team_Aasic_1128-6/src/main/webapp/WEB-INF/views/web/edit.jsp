                       ...
                       <form action="updateOK.user" method="post" id = "modiForm" name = "modiForm">
                        ...
                        <div class="bg-light rounded h-100 p-4" style="width:600px; padding-top:40px;">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id = "userid" name = "userid" class="form-control" value="${sessionScope.userid} (수정불가)" aria-label="user 입력"
                                    aria-describedby="basic-addon1" readonly>
                            </div>
                            <br>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Password</span>
                                <input type="text" id = "pwd" name = "pwd" class="form-control" placeholder="Password를 입력하세요" aria-label="pwd 입력"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <span class="input-group-text" id="basic-addon2"><select class="form-select" name="email" id="floatingSelect"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id = "name" name = "name" class="form-control" placeholder="이름을 입력하세요" aria-label="이름 입력"
                                    aria-describedby="basic-addon1">
                            </div>
                            <br>
                            <!-- <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Phone</span>
                                <input type="text" id = "phone" name = "phone" class="form-control" placeholder="전화번호를 입력하세요( '-' 없이 입력하세요)" aria-label="pwd 입력" maxlength = "11"
                                    aria-describedby="basic-addon1">
                            </div>
                            <br> -->
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1"><select class="form-select" name="phone" id="floatingSelect"
                                    aria-label="Floating label select example">
                            ...
                            <br>
                             <div class="input-group mb-3">
                                ...
                                <input type="text" id = "address" name = "address" class="form-control" placeholder="이름을 입력하세요" aria-label="이름 입력"
                                    aria-describedby="basic-addon1">
                            </div>
                            <br>
