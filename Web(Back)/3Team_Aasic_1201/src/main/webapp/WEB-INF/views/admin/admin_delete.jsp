...
<body>
        ...
        <jsp:include page="/WEB-INF/views/include/adminheader_css.jsp"></jsp:include>
          <!-- content -->
          		...
          		<!-- 회원의 스테이터스를 0으로 만드는 쿼리문, 다영이가 같은 기능 버튼으로 구현하면 없앨 예정 -->
          			<div align="center" style="padding-top:30px; padding-bottom:20px;">
          				<div style="padding-top:30px; color:#007FFF;"><b align="center"> 계정 정지할 회원의 ID를 입력 </b></div>
							<form name="bbs" action="userDeleteOK.do" method="POST">
							<div style="padding-top:30px; padding-bottom:20px;"><input name="userid" size="25">
          ...
          <table class = "table table-blue">
			...
			<c:forEach var="memberList" items="${requestScope.memberList}">
				<tr>
					...
					<td><input class="btn btn-primary rounded-pill m-2" type="button" onclick="check();" value="정지" userid="${memberList.userid}"></td>
