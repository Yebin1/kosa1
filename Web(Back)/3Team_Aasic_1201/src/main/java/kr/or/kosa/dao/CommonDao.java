...
public class CommonDao {
	...
	public int deleteOk(String idx) {
		try {
			conn = ds.getConnection();
			sql1 = "update board set boardstatus=0 where idx=?";
			pstmt1 = conn.prepareStatement(sql1);
	...
	// 유저 게시글 삭제하기
	public int userDeletOk(String idx, String userid) {
		try {
			conn = ds.getConnection();
	...
	public int adminDelete(String boardname) {
		try {
			conn = ds.getConnection();
			sql1 = "delete from board where boardname = ? and boardstatus = 0";
			pstmt1 = conn.prepareStatement(sql1);
	...
	public int adminAllDelete() {
		try {
			conn = ds.getConnection();
			sql1 = "delete from board where boardstatus = 0";
			pstmt1 = conn.prepareStatement(sql1);
			resultRow = pstmt1.executeUpdate();
		} catch (Exception e) {
			e.printStackTrace();
