			...
			<table class="table"><!-- width="80%" border="1" cellspacing="0" align="center" -->
				...
				<c:forEach var="board" items="${boardList}">
					<tr onmouseover="this.style.backgroundColor='skyblue'" onmouseout="this.style.backgroundColor='white'">
						<td align="center"><span style="color:red;">[${board.boardheader}]</span></td>
						<td>
				...
				<tr>
					<td colspan="3" align="center" >
						<!--이전 링크 --> 
						<c:if test="${cpage > 1}">
							<a href="boardList.user?boardname=${boardname}&cp=${cpage-1}&ps=${pagesize}&boardname=${boardname}&boardheader=${boardheader}&totalboardcount=${totalboardcount}">이전</a>
						...
						<c:forEach var="i" begin="1" end="${pagecount}" step="1">
							<c:choose>
								...
								<c:otherwise>
									<a href="boardList.user?boardname=${boardname}&cp=${i}&ps=${pagesize}&boardname=${boardname}&boardheader=${boardheader}&totalboardcount=${totalboardcount}">[${i}]</a>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						<!--다음 링크 --> 
						<c:if test="${cpage < pagecount}">
							<a href="boardList.user?boardname=${boardname}&cp=${cpage+1}&ps=${pagesize}&boardname=${boardname}&boardheader=${boardheader}&totalboardcount=${totalboardcount}">다음</a>
						</c:if>
					</td>
