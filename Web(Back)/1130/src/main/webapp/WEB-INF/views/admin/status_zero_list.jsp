...
<body>
  <!-- 사이드바 들어갈 자리 -->
   ...
   <div id="pagecontainer">
      ...
      <h4 class="mb-4"><b><span style="color:#2C91F7;">${boardname}</span>게시판</b></h4>
      <b>삭제 대기글 목록</b><br><br>
         <table class="table">
            <tr>
               <td colspan="6">
            ...
            <tr>
               <td colspan="4" align="center" >
                  <!--이전 링크 --> 
                  <c:if test="${cpage > 1}">
                     <a href="statusZero.admin?boardname=${boardname}&cp=${cpage-1}&ps=${pagesize}&boardname=${boardname}">이전</a>
                  ...
                  <c:forEach var="i" begin="1" end="${pagecount}" step="1">
                     <c:choose>
                        ...
                        <c:otherwise>
                           <a href="statusZero.admin?boardname=${boardname}&cp=${i}&ps=${pagesize}&boardname=${boardname}">[${i}]</a>
                        </c:otherwise>
                     </c:choose>
                  </c:forEach>
                  <!--다음 링크 --> 
                  <c:if test="${cpage < pagecount}">
                     <a href="statusZero.admin?boardname=${boardname}&cp=${cpage+1}&ps=${pagesize}&boardname=${boardname}">다음</a>
                  </c:if>
               </td>
