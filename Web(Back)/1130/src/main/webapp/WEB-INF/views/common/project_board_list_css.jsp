...
<link href="images/kingbird.ico" rel="icon">
    ...
    <script	src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
        ...
        $(function(){
        	$('#boardheader').on('change', function(){
        			var kind = $(this).val();  //버튼이 클릭 되었을 때 그 버튼의 value를 var kind로 가져와서	
        			$.ajax({
        				 url : "HeaderSearchService.user", // 이 주소로 
				...
				<tr>
					<td colspan="3" align="center" >
						...
						<c:if test="${cpage < pagecount}">
							<a href="boardList.user?boardname=${boardname}&cp=${cpage+1}&ps=${pagesize}&boardheader=${boardheader}">다음</a>
						</c:if>
					</td>
