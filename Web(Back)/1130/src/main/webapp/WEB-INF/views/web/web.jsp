            ...
            <%-- <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                    	<!-- <div><h4>개발언어 차트 들어갈 부분</h4> -->
                    	</div>
                    	<div class="col-sm-12 col-xl-6"  style="width:300px;">
								<div class="bg-light rounded h-100 p-4" style="width:400px; floating:left; padding-left:0px;">
									<h4 class="mb-4">이용자 사용언어 현황</h4>
									<canvas id="bar-chart">사용 언어</canvas>
								</div>
								<div class="col-sm-12 col-xl-6" style="width:400px; floating:left;margin-right:0px;">
	                 			 <div class="bg-light rounded h-100 p-4">
	                   				  <h6 class="mb-4">일별 사용자 현황</h6>
	                    			  <canvas id="worldwide-sales"></canvas>
                 				  </div>
               						</div>
							</div>
               ...
               function() {
                  ...
                  $.ajax({ // 파일이 아닌 url 주소로 요청을 보냄.
                     ...
                     success : function(data) {
                        ...
                        console.log("1 : " + perdate)
                        console.log("1 : " + boardcnt)
